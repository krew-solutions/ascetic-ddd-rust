...
| [`ascetic-ddd-event-store`](crates/event-store) | `seedwork/infrastructure/repository/event_store` | Event store on PostgreSQL: streams appended with an expected position, payloads sealed with the stream's DEK |
